      ...
      <div class="container">
        <div class="child">
            ...
            <form action="php/login_usuario.php" class="form-login" method="POST">
                ...
                <input type="text" name="lo_correo"><span class="barra"></span>
                <label for="correo">Correo</label>
                </div>
                <div class="form-group">
                <input type="password" name="lo_contra"><span class="barra"></span>
                <label for="contra" style="margin-top: 15px;">Contraseña</label>
                </div>
                <div class="botones">
                <button class="btn-dark">Iniciar Sesion</button>
            </form>
            <button type="button" class="btn btn-dark">Olvide la contraseña</button>
            <br>
            </div>
            <div class="Registro">
            <br>
